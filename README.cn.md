...
[![x-cmd/install — chsrc Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/chsrc.svg?lang=zh)](https://x-cmd.com/install/chsrc)
...
合计: **10,849** 行代码（覆盖前 5 种语言、共 **113** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| C | 7,989 | 1,745 | 2,158 | 86 |
| CHeader | 1,809 | 746 | 431 | 17 |
| Sh | 518 | 128 | 113 | 5 |
| PowerShell | 186 | 64 | 49 | 3 |
| Makefile | 168 | 78 | 85 | 2 |

## 源代码

- **上游仓库**: <https://github.com/RubyMetric/chsrc>
- **官网**: <https://chsrc.run/>
- **许可证**: GPL-3.0
...
- **Star**: 6,885 · **Fork**: 285 · **开放 issue**: 195 · **贡献者**: 36

## 累计统计

- **发布数**: 13 · **已合并 PR**: 133 · **开放 PR**: 3 · **已关闭 issue**: 175 · **开放 issue**: 20 · **提交数**: 2119

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 4 | 2 | 1 | 4 | 23 |
| last60d | 2026-07-26 | 1 | 13 | 3 | 2 | 7 | 119 |
| 90d | 2026-06-26 | 2 | 15 | 3 | 4 | 7 | 130 |
| last180d | 2026-03-28 | 2 | 19 | 3 | 11 | 8 | 143 |
| 360d | 2025-09-29 | 5 | 46 | 3 | 35 | 8 | 293 |
| last720d | 2024-10-04 | 9 | 114 | 3 | 125 | 18 | 1264 |
...
chsrc 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `chsrc` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/chsrc.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:02:12Z._
